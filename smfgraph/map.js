var manifestMap = $.extend({
  ...
  'svc:/network/ipfilter': [['/lib/svc/manifest/network/ipfilter.xml', 'https://github.com/joyent/smartos-live/blob/master/overlay/generic/lib/svc/manifest/network/ipfilter.xml']],
  'svc:/network/location': [['/lib/svc/manifest/network/network-location.xml', 'https://github.com/joyent/smartos-live/blob/master/overlay/generic/lib/svc/manifest/network/network-location.xml']],
  'svc:/network/physical': [['/lib/svc/manifest/network/network-physical.xml', 'https://github.com/joyent/smartos-live/blob/master/overlay/generic/lib/svc/manifest/network/network-physical.xml']],
  'svc:/system/smartdc/config': ['/lib/svc/manifest/system/smartdc/config'],
  'svc:/system/smartdc/init': ['/lib/svc/manifest/system/smartdc/init'],
  'svc:/system/smartdc/metadata': ['/lib/svc/manifest/system/smartdc/metadata'],
  'svc:/system/smartdc/vmadmd': ['/lib/svc/manifest/system/smartdc/vmadmd'],
...
var methodMap = $.extend({
  ...
  'svc:/network/ipfilter': ['/lib/svc/method/ipfilter'],
  'svc:/network/location': ['/lib/svc/method/net-loc'],
  'svc:/network/physical': [['/lib/svc/method/net-physical', 'https://github.com/joyent/smartos-live/blob/master/overlay/generic/lib/svc/method/net-physical']],
  'svc:/system/smartdc/config': ['/lib/svc/method/system/smartdc/config'],
  'svc:/system/smartdc/init': ['/lib/svc/method/system/smartdc/init'],
  'svc:/system/smartdc/metadata': ['/lib/svc/method/system/smartdc/metadata'],
  'svc:/system/smartdc/vmadmd': ['/lib/svc/method/system/smartdc/vmadmd'],
